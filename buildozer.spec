...
# (str) Package name
package.name = economia

# (str) Package domain (needed for android/ios packaging)
package.domain = com.economia
...
#       [app]
#       title = Economia # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Economia
#          package.name = economia # This is all part of the title.
#
